...
#        DEPENDEES install)
    ...
    ExternalProject_Add( ${TARGET_NAME}
	    ...
	    BUILD_IN_SOURCE 1
		CONFIGURE_COMMAND ""
		BUILD_COMMAND make -fwin32/Makefile.gcc CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} CFLAGS=-fPIC DESTDIR=<INSTALL_DIR>
		INSTALL_COMMAND make -fwin32/Makefile.gcc install CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} CFLAGS=-fPIC DESTDIR=<INSTALL_DIR>
    )
else()
    ExternalProject_Add( ${TARGET_NAME}
		DOWNLOAD_DIR ${DOWNLOAD_DIR}
